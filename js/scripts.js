...
var colorsArr = [];
var hexCode = [];
function getArrs(obj){
  for (var key in obj){
    colorsArr.push('"' + key + '"');
    hexCode.push('"' + obj[key]["color"] + '"');
  }

  document.getElementById('hex-codes').innerHTML =hexCode;
document.getElementById('language-names').innerHTML =colorsArr;
